...
public class TC02_CreateRecordMethod {

	// Create a method and call the method in Main method
	...
	public static void main(String[] args) throws InterruptedException {
		TC02_CreateRecordMethod tc02_CreateRecord = new TC02_CreateRecordMethod();
		tc02_CreateRecord.createRecord();
